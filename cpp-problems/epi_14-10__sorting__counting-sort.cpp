...
/* Group Items In Array :
    ...
    Use two maps 
        - map for count of each type
        - map for starting offset of each type
    Take first item in offset map, use as index to pull from input array 
    Lookup input's correct offset in offset map
